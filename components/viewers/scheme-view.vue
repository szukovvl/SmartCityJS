...
<script>
import SchemeMainStationCadr from '~/components/viewers/scheme-main-station-card.vue'
import SchemeUnknownCadr from '~/components/viewers/scheme-unknown-card.vue'
import SchemeGeneratorCadr from '~/components/viewers/scheme-generator-card.vue'
import SchemeConsumerCadr from '~/components/viewers/scheme-consumer-card.vue'
import SchemeDistributorCadr from '~/components/viewers/scheme-distribotor-card.vue'
import {
...
export default {
  ...
  computed: {
    ...
    consumers () {
      const items = this.$store.state.gameResources[ESO_CONSUMER_TYPE]
      return items !== undefined ? items : []
    },
    distributors () {
      const items = this.$store.state.gameResources[ESO_DISTRIBUTOR_TYPE]
      return items !== undefined ? items : []
    },
    root () {
      const items = this.$store.state.gameResources[ESO_MAINSTATION_TYPE]
      if (items !== undefined) {
